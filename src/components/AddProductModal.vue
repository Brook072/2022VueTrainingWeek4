...
onMounted(() => {
  productModalBS.value = new Modal(document.getElementById("addProductModal"));
  productModalDOM.value = document.getElementById("addProductModal");
    ...
    <div class="modal-dialog modal-xl">
      <div class="modal-content border-0">
          ...
          <div class="row">
            <div class="col-sm-4">
              ...
              <div class="mt-3" v-if="modalTarget.imageUrl">
                ...
                <div>
                  <button
                    @click.prevent="imageOnChange = modalTarget.imageUrl"
                    class="btn btn-outline-success d-block w-100 btn-sm mb-1"
                  >
                    主要圖片
                  </button>
                  <button
                    @click.prevent="imageOnChange = img"
        ...
        <div class="modal-footer">
          ...
          <button @click.prevent="addGoodsPost()" class="btn btn-primary">
            確認
          </button>
        </div>
      </div>
